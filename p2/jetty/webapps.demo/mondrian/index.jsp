...
<ul>
<li><a href="testpage.jsp?query=query_geografia">Query Geography</a></li>
<li><a href="testpage.jsp?query=query_clientes">Query Client</a></li>
<li><a href="testpage.jsp?query=query_categorias">Query Category</a></li>
<li><a href="testpage.jsp?query=query_campanyas">Query Campaign</a></li>
<li><a href="testpage.jsp?query=query_all">Query All</a></li>
</ul>
