...
// on Fri Nov 02 14:27:05 EST 2012
 ...
 * their contents.
 * The attributes of the root tag <Model> refers to the generated
 * file MondrianGuiDef.java and its import statements.
 * The 'aggregator' attribute of the Measure element requires the
 * <Value> tags to generate a drop-down of possible options in
 * the Schema Workbench.
 * Revision is $Id$
 * <p>This class was generated from XOM model 'mondrian' on Fri Nov 02 14:27:05 EST 2012
 */
...
// implement CubeDimension
	...
	public static class Hierarchy extends org.eigenbase.xom.ElementDef
	{
		 ...
		 * {@link MondrianGuiDef.Join set of tables},
		 * {@link MondrianGuiDef.View SQL statement}, or
		 * {@link MondrianGuiDef.InlineTable inline table}
	...
	public static class Measure extends org.eigenbase.xom.ElementDef
	{
			...
			throws org.eigenbase.xom.XOMException
		{
			try {
				...
				aggregator = (String)_parser.getAttribute("aggregator", "String", null, _aggregator_values, true);
				formatter = (String)_parser.getAttribute("formatter", "String", null, null, false);
				caption = (String)_parser.getAttribute("caption", "String", null, null, false);
				description = (String)_parser.getAttribute("description", "String", null, null, false);
				visible = (Boolean)_parser.getAttribute("visible", "Boolean", null, null, false);
		...
		public static final String[] _aggregator_values = {"sum", "count", "min", "max", "avg", "distinct count", "distinct-count"};
...
/**
	...
	public static class SQL extends org.eigenbase.xom.ElementDef
	{
			...
			throws org.eigenbase.xom.XOMException
		{
			try {
				org.eigenbase.xom.DOMElementParser _parser = new org.eigenbase.xom.DOMElementParser(_def, "", MondrianGuiDef.class);
				dialect = (String)_parser.getAttribute("dialect", "String", "generic", _dialect_values, true);
				cdata = _parser.getText();
			} catch(org.eigenbase.xom.XOMException _ex) {
				throw new org.eigenbase.xom.XOMException("In " + getName() + ": " + _ex.getMessage());
			}
		...
		public static final String[] _dialect_values = {"generic", "access", "db2", "derby", "firebird", "hsqldb", "mssql", "mysql", "oracle", "postgres", "sybase", "teradata", "ingres", "infobright", "luciddb", "vertica", "neoview", "greenplum", "vectorwise", "hive"};
...
public int hashCode() {
            ...
            public boolean equals(Object obj) {
                ...
                for (StackTraceElement st : stack.getStackTrace()) {
                    if (st.getClassName().equals("javax.swing.tree.TreePath")) {
                        return this == obj;
                    }
                }
...
private java.util.Map<String,String> hintMap;
            ...
            public boolean equals(Object o) {
                ...
                // Following code is disabled to resolve problem of disappearing
                // schema elements from tree panel.
