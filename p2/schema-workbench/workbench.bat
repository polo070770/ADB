...
"java" -Xms100m -Xmx500m -cp "%CP%" -Dlog4j.configuration=file:///%ROOT%\.schemaWorkbench\log4j.xml mondrian.gui.Workbench -Djavax.net.ssl.trustStore=.truststore -Djavax.net.ssl.trustStorePassword=08289l6d1
